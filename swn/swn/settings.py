"""
Django settings for swn project.
...
SECRET_KEY = 'xa(nimk4vomor$sr7ki_z)nds%!p#jui52r8ns&zp%3ux89^0%'
...
# Media files (needed in this case for contextual image loading)
